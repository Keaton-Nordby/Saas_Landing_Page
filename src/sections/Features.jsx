            ...
            <Element name="features">
                <div className="container">
                    ...
                    max-md:border-none max-md:rounded-none max-md:gap-3">
                        ...
                        border-2 border-s3 rounded-7xl mad-md:hidden">
                            ...
                            {details.map(({ id, icon, title }) => (
                                <li key={id} className="relative pt-16 px-4 pb-14">
                                    ...
                                    mx_auto mb-3 border-2 border-s2 rounded-full hover:border-s4
                                    ...
                                    <h3 className={"relative z-2 max-w-36 mx-auto my-0" +
