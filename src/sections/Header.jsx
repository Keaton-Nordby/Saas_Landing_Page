...
const NavLink = ({ title }) => (
    <LinkScroll
       className="base-bold text-p4 uppercase tansition-colors duration-500 cursor-pointer hover:text-p1 max-lg:my-4 max-lg:h5">
        {title}
            ...
            <div className="container flex h-14 items-center max-lg:px-5">
                ...
                <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0', isOpen ? 'max-lg:opacity-100' : "max-lg:pointer-events-none")}>
                    <div
                        ...
                        <div
                            className="lg:hidden block absolute top-1/2 left-0 w-[906px] h-[380px] translate-x-[290px] -translate-y-1/2 rotate-90">
